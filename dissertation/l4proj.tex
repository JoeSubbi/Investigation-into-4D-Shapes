...
\begin{abstract}
    ...
    \vskip 0.4em
    To allow users to fully explore four dimensional geometry, a 4D rotor was developed, allowing for the stable rotation of geometry in $\mathbb{R}^4$.
    \vskip 0.4em

    TODO: Results of Experiment
    It was found that ...

    %users work better with less information
    %novice users cannot take advantage of pros, and cons become more obvious
...
From the collected quantitative data from the experiments, combined with the qualitative data collected via the experiments survey, ...
...
less correct if more happening on screen
%
\vskip 0.4em
