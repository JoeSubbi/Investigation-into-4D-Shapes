...
Whilst this projects focus on manipulating geometry is focussed around software, it is worth noting that hardware based approaches to interaction exist. An example of 3D manipulation using hardware is 
the \textit{Rockin'Mouse} \citep{balakrishnan_rockinmouse_1997}.
