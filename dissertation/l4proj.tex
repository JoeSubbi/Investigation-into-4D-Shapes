...
Furthermore, Does a users understanding and ability to manipulate 4D objects increase with practice?
...
Level 2: students create meaningful definitions and are able to provide meaningful definitions to justify any reasoning.
...
\vskip 0.5em
For the purposes of this experiment, levels 1-3
...
The core of this project focuses on the development of a system capable of rendering several four dimensional objects, and be able to view these objects in a series of ways as to teach
...
MoSCoW is a prioritisation technique used in project planning. The purpose of MoSCoW is to separate the requirements of a project into four levels of priority: Must have, Should have, Could have and Won't have. This process may be revisited several times during a projects development lifecycle; different requirements are often re-prioritised based on project progress or project direction.
...
\vskip 0.5em
a tutorial video to teach and explain 4d\\
...
\vskip 0.5em
multiple tests to evaluate a persons understanding of several aspects of geometry
