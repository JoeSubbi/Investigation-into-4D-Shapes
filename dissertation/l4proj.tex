...
The following data is compiled from a total of 11 participants. All participants remained anonymous and provided explicit permission for their data to be analysed. Of the 11 participants, 5 attended in person. The remaining 6 participants attend the experiment remotely, and as such were subject to potentially limited browser performance.
...
\vskip 0.4em
With each iteration of a new representation, it can be seen that users perform a little worse earlier on, and submit their answer faster after gathering practice over time (\cref{fig:pos_stats}).
...
The pentachoron was found to be the least easy object to manipulate, and required more interaction that any other.
