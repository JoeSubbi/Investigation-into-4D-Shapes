...
\begin{lstlisting}[language=glsl, float, caption={Given a light position \texttt{lightPos}, shade a surface in the scene based on the fall off angle and cast a shadow, if a surface is obstructing another surface from the light source}, label=lst:rm_light]
...
\vskip 0.5em
The torus was an interesting shape; two variations were developed for this project.
...
Alternatively, consider a four dimensional torus with three radii: $r_1$, $r_2$ and $r_3$.

TODO: torus with 3 radii
