...
Texturing the three dimensional cross section of four dimensional objects is a rather odd task given only a slice of the object can be seen at a given time. It is however, a necessary task in order to identify and distinguish different faces of a symmetric object.
