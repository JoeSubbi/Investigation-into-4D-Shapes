...
\vskip 0.5em
A primitive solution proposed by \citet{kageyama_keyboard-based_2005} explores the idea of using keyboard inputs to rotate an object in all 6 DoF. This system allows users to compose rotation matrices to rotate an object. This allows for incremental control over how an object rotates. As the system uses rotation matrices, it is at risk of gimbal lock. Furthermore, key presses are discrete. A more desireable approach may be to utilise a mouse for a more continuous spectrum of rotation, with an optional incremental feature, as is standard with most 3D software.
\vskip 0.5em
\citet{yan_multitouching_2012} takes advantage of multi-touch screen devices, and the different gestures that can be accomplished with two or more. Multi-touch presents itself as an easier and more intuitive secondary input opposed to keyboard presses.
