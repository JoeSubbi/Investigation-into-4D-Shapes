...
\vskip 0.4em
The 4D hyper-cube proved the hardest shape to manipulate, with participants scoring lower accuracies when dealing with it. Participants also took more time to submit their final pose compared to other shapes. 
...
The pentachoron was found to be the least easy object to manipulate, and required more interaction that any other shape.
...
Participants found it easier to distinguish several planes of rotation.
\vskip 0.4em
%cons
...
Over the course of this investigation, a system capable of rendering the cross sections several 4D shapes, in real time, was developed with the use of ray marching. Manipulation techniques were experimented with, and a system to rotate geometry without fear of instability or gimbal lock was employed. Three extensions to the 3D cross section of 4D geometry were developed and experimentally validated. Experiments placed a core focus on teaching participants about the fourth dimension in order to equip them with the necessary knowledge to reliably evaluate these representations of geometry.
\vskip 0.4em
The concept of four dimensional geometry can be unintuitive to users with limited experience. Despite this, over a two hour period of which an experiment was conducted, participants showed very clear signs of learning and improvement. 
...
\vskip 0.4em
Through the collected qualitative date, contrary to that displayed in \cref{fig:shape_stats}, participants felt the w-axis timeline representation assisted in a users understanding of the geometry.
Unfortunately, throughout the experiments, the multi-rotational view proved very limited to novice users. Participants felt overwhelmed by the information presented, which often lead to misinterpretation of the behaviour exhibited whilst an object was under continuous rotation.
...
Perhaps with more time to conduct an experiment, the investigation may have been able to properly take advantage of the van-Hiele model in order to produce more conclusive results.
Future works might include an experiment that considers a progressive teaching experience, allowing participants to build a satisfactory understanding of four dimensions, prior to evaluating each extension.
\vskip 0.4em
...
Alternatively, further exploration into intuitive manipulation mechanics such as an implementation of a double arcball \citep{shoemake_arcball_1994} system to more effectively manipulate 4D geometry.
Finally, it would be of interest to conduct research into more complex visualisation methods such as 4D stereographic projection, and quantifiably compare it to the 3D cross section.
