...
\begin{figure}
  ...
  \end{subfigure}
  \caption{
    Quad-planar projection of colours and textures using 4D normal vectors.
    \subref{fig:tex1} shows positive components coloured $x$: Red, $y$: Green, $z$: Blue and $w$: white. Negative components are dark and shaded with diffuse lighting.
    \subref{fig:tex2} shows patterns projected along each axis. negative components of the normal vector are coloured Blue, and positive are coloured Red.
    \subref{fig:tex3} shows patterns projected along each axis. Positive components coloured $x$: Red, $y$: Green, $z$: Blue and $w$: white. Negative components are dark and shaded with diffuse lighting.
  }
  \label{fig:textures}
\end{figure}
%
