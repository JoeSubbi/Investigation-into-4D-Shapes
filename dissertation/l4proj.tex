...
This investigation aims to evaluate the effectiveness of each of the three extensions to the 3D cross section of 4D geometry. Each extension has the potential to assist in a viewers understanding with respect to different aspects of geometry. Therefore the goal of the investigation is to evaluate what aspect of geometry, if any, each of the three representations may assist a user in interpreting. To reiterate \cref{aims}: Which representation is more effective at conveying the surface geometry, the rotational pose, or assisting a users in manipulate geometry in $\mathbb{R}^4$ ?
...
\begin{algorithm}[H]
  ...
  \KwResult{\\
    \quad $\theta$ Minimum angle required to rotate one entity to another. $0_{rads} < \theta < \pi_{rads}$
  }
  \Begin{
...
\vskip 0.4em
The concept of four dimensional geometry can be unintuitive to users with limited experience. Despite this, over a two hour period where the experiment was conducted, participants showed very clear signs of learning and improvement. 
...
It was also found that abstracting complex phenomena such as rotations in $mathbb{R}^4$ assisted users when identifying active planes of rotation.
\vskip 0.4em
Through the collected qualitative date (contrary to \cref{fig:shape_stats}) participants felt the w-axis timeline representation assisted in a users understanding of the geometry.
...
With more time to conduct an experiment, the investigation may have been able to properly take advantage of the van-Hiele model in order to produce more conclusive results.
...
\vskip 0.4em
Other areas of interest include the development of a system to render mesh based geometry, allowing for the creation of more complex shapes. Alongside this, further exploration into intuitive manipulation mechanics, such as a double arcball \citep{shoemake_arcball_1994} system, to more effectively and precisely manipulate 4D geometry.
