...
Referred to in this paper as the grab ball, is the most commonly employed method of controlling the rotation of an object. The grab ball provides the user with control over the objects rotation, relative to the objects local axis. As such, 
