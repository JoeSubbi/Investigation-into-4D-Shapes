...
Both \citet{bosch_n-dimensional_2020} and \citet{tianli_4d_2018} have developed real time interactive systems which render four dimensional objects using a mesh. As illustrated by \citet{tianli_4d_2018}, 4D shapes are made up of cells. The most basic cell is the tetrahedron. A tetrahedron is made up of four triangles defined by faces, vertices and edges. A pentachoron, also known as a hyper-tetrahedron or a 5-cell; the mesh of which is of course consists of 5 tetrahedral sub-meshes, each consisting of 4 triangles.
\vskip 0.5em
Mesh based rendering allows the creation of very complex higher dimensional objects

TODO: tianli used Unity, Bosch created his own physics engine\\
TODO: The complexities revolve around cross section

\subsection{Ray Marching Shaders}

Despite of advancements in, ray marching has not lost its place in the world. Whilst less intuitive and approachable than mesh based rendering, ...

TODO: quilez actiely exploring ray marching for change\\
