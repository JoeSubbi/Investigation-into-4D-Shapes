...
\end{equation}
%
Initially the equations for the rotor-rotor product and the rotation of a vector where derived by hand, similar to \cref{eq:geo_prod}. There were however consistent errors in the behaviour of the objects rotations. These errors related to the vector produced from the rotor-vector sandwich product (\cref{eq:sandwich_a}). 

TODO: sympy and galgebra
